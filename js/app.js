...
const wordBank = [
    ...
    {   word: "MARS",
        hint: "Often called the Red Planet because of its reddish appearance, it has the tallest volcano and the deepest canyon in the solar system."
    },
    {   word: "JUPITER",
    ...
    {   word: "NEPTUNE",
        hint: "Known for its deep blue color due to its methane atmosphere, it has strong winds and is the farthest planet from the Sun."
    },
    {   word: "PLUTO",
